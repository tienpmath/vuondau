...
function Footer() {
  ...
  const handleEmailClick = () => {
    const email = "http://vuondautuvi.com/";
  ...
  return (
    <div className=" flex flex-col ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3  grap-6 sm:px-8 px-5 py-8 sm:text-center bg-white">
        <ul className="px-[4%] p-2 text-center sm:text-start flex sm:block flex-col items-center">
          ...
          <div className="flex items-center pl-2 pt-2">
            ...
            <p className=" pl-2">Địa chỉ : hẻm 31/8 đường 3 tháng 4 phường 3 , TP đà Lạt 
</p>
          </div>
          <div
          ...
          >
            ...
            <p className=" pl-2">Phone: 0976190018</p>
          </div>
          <div className="flex items-center pl-2 pt-2 ">
            <FaEarthAsia style={{ fontSize: "18px", fontWeight: "700" }} />
            <p className=" pl-2">Website: http://vuondautuvi.com/</p>
          </div>
          <div
            className="flex items-center pl-2 pt-2 cursor-pointer hover:text-[#0e9c49]"
          ...
          >
            ...
            <p className=" pl-2">Email: vuondautuvi@gmail.com</p>
          </div>
          <div className="flex my-2">
            <Link to="https://www.facebook.com/people/V%C6%B0%E1%BB%9Dn-D%C3%A2u-T%C3%BA-Vi-%C4%90%C3%A0-L%E1%BA%A1t/61559740124088">
              <FacebookFilled
                className="text-blue-700 mx-2 "
                style={{ fontSize: "32px" }}
              />
            </Link>
             <Link to="https://www.tiktok.com/@vuondautuvifarm?">
      ...
      <div className="grid grid-cols-1 sm:px-8 px-5 py-2 text-center bg-[#009b49] text-white">
        <span className="font-[600]">Copyright 2025 vuondautuvi.com</span>
      </div>
    </div>
  );
}
